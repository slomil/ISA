...
<title>Registracija menadzera sistema</title>
</head>
<body>

	<div class="polje1">
	<c:url var="action" value="/systemManager/registracijaMenadzeraSistema/try" />
		<form:form id="register3" action="${action}" method="post" modelAttribute="userRegistration">
		    ...
		    <tr>
				...
				<form:hidden path="role" value="SYSTEM_MANAGER"/>
